...
function M.setup_keymaps(buf)
	...
	vim.keymap.set("n", "H", actions.goto_cwd, { buffer = buf, nowait = true })
	vim.keymap.set("n", "L", actions.change_pwd, { buffer = buf, nowait = true })
	...
	vim.keymap.set("n", ".", actions.toggle_hidden, { buffer = buf, nowait = true })
end
